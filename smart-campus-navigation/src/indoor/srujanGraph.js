...
export const floor3 = createFloorTopology(3, {
  slot1: { id: "lab_301_cs", label: "CS Lab 301" },
  slot2: { id: "lab_302_cs", label: "CS Lab 302" },
  slot3: { id: "class_303", label: "Classroom 303" },
  slot4: { id: "washroom_3", label: "Washroom" },
  slot5: { id: "utility_304", label: "Utility Room" }
})

export const floor2 = createFloorTopology(2, {
  slot1: { id: "class_201", label: "Classroom 201" },
  slot2: { id: "class_202", label: "Classroom 202" },
  slot3: { id: "class_203", label: "Classroom 203" },
  slot4: { id: "washroom_2", label: "Washroom" },
  slot5: { id: "hod_it", label: "IT HOD Office" }
})

export const floor1 = createFloorTopology(1, {
  slot1: { id: "class_101", label: "Classroom 101" },
  slot2: { id: "class_102", label: "Classroom 102" },
  slot3: { id: "staff_room_s", label: "Staff Room" },
  slot4: { id: "washroom_1", label: "Washroom" },
  slot5: { id: "reception", label: "Reception" }
})
